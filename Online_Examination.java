...
{  
    ...
    {     
        ...
        userLabel.setFont(new Font("Arial", Font.PLAIN, 30));   //"<b><font face=\"Verdana\" size=\"30\"> This is a demo text with a different font!</font></b>"  
        textField1 = new JTextField(15);
        Font bigFont1 = textField1.getFont().deriveFont(Font.PLAIN, 30f);
        textField1.setFont(bigFont1);
        JLabel passLabel = new JLabel("                        Password");    
        passLabel.setFont(new Font("Arial", Font.PLAIN, 30));    
        textField2 = new JPasswordField(8);  
        Font bigFont2 = textField2.getFont().deriveFont(Font.PLAIN, 30f); 
